...
@Component
public class Rule020ExtractSenderId extends AttributeExtractRuleAsyncBase {
	...
	public void doExtractAsync(List<Object> objList, IAttributeExtractRuleListener attributeExtractRuleListener) {
		...
		attributeData.setAttrNameCde(EnumSystemAttributeName.FROM_ID.getCde()) // 20=FromId
				.setAttrValue(emailData.getEmailAddressFrom().getEmailId().toLowerCase())
