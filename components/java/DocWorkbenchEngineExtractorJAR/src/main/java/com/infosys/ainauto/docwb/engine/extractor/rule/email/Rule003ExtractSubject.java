...
@Component
public class Rule003ExtractSubject extends AttributeExtractRuleAsyncBase {
	...
	public void doExtractAsync(List<Object> objList, IAttributeExtractRuleListener attributeExtractRuleListener) {
		...
		String emailSubject = StringUtility.findAndReplace(emailData.getEmailSubject(), StringUtility.NON_ASCI_REGEX, "");

		AttributeData attributeData = new AttributeData();
		attributeData.setAttrNameCde(EnumSystemAttributeName.SUBJECT.getCde()) // 3=EmailSubject
				.setAttrValue(emailSubject).setExtractType(EnumExtractType.DIRECT_COPY).setConfidencePct(100);
