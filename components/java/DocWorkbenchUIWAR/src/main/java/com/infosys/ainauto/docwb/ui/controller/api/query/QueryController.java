...
package com.infosys.ainauto.docwb.ui.controller.api.query;
...
public class QueryController extends BaseController {
	...
	@RequestMapping(value = "/elasticsearch", method = RequestMethod.POST, consumes = {
			MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_JSON_VALUE }, produces = {
					MediaType.APPLICATION_JSON_VALUE, MediaType.APPLICATION_JSON_VALUE })
	ResponseEntity<String> queryData(@RequestBody QueryReqData queryReqData) {
