...
public class FileSystemDataSourceProviderTest extends BaseTest {

	private final static Logger logger = LoggerFactory.getLogger(FileSystemDataSourceProviderTest.class);
