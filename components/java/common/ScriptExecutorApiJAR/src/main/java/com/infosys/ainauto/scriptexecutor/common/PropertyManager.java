...
package com.infosys.ainauto.scriptexecutor.common;
...
public final class PropertyManager {
	...
	private static final String INTERNAL_PROP_FILE_NAME = "scriptexecutor.properties";
	...
	private static Properties loadInternalProperties(String propertiesFile) {
		...
		try {
			input = ScriptExecutorFactory.class.getClassLoader().getResourceAsStream(propertiesFile);
			if (input == null) {
