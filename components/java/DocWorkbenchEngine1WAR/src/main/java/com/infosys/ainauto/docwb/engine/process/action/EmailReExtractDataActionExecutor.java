...
@Component
@ExtractAttributeActionExecutor(title = "Re-Extract Data - Email", jsonConfigFile = "attributeRuleMappingConfig.json")
public class EmailReExtractDataActionExecutor extends ExtractAttributeActionExecutorBase {
