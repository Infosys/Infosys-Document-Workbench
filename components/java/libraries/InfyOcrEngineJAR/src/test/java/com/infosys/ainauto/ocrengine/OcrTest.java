...
public class OcrTest {
    ...
    @Test
    public void testJsonInputToTextOnlyTxt() throws Exception {
        String outputPath = RESOURCE_PATH + "output\\";
        String fromFile = RESOURCE_PATH + "input\\" + "image_list.json";
        String expectedTxtFilePath = outputPath + "image_list.json_infy_ocr_engine.json";
        String lang = "eng";
        String ocrFormat = "txt";
        String pageSegMode = "3";
        TestHelper.recursiveDelete(new File(expectedTxtFilePath));
