...
public class TestHelper {
	...
	public static String getUnitTestDataFolderRootPath() {
		// C:/Users/XXX/Infosys Limited
		String unitTestDataFolderPath = System.getenv("INFY_SP_ROOT_PATH");
		unitTestDataFolderPath += "/workbenchlibraries - Documents/SHARED_DATA/unit_test_data/infy_format_converter";
		return unitTestDataFolderPath;
	}
}
