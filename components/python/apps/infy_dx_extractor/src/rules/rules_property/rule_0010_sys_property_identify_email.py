...
class Rule0010SysPropertyIdentifyEmail(RulePropertyBaseClass):
    ...
    def extract(self, doc_data_dict: dict) -> RESPONSE_DICT:
        ...
        try:
            ...
            email_parser_service = EmailParserService(doc_file_path)
            if email_parser_service.is_valid_email():
                response_val_dict["text"] = "true"
        except Exception:
            pass
